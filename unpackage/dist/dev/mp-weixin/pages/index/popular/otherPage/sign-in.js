      ...
      return common_vendor.e({
        ...
        b: common_vendor.f(classData.value, (value, index, i0) => {
          return common_vendor.e({
            ...
            o: value.isStudyToday === "1"
          }, value.isStudyToday === "1" ? {
            p: common_vendor.o(($event) => goToDetail(value, index))
          } : value.isStudyToday === "0" ? {
            r: common_vendor.o(($event) => goToDetail(value, index))
          } : {}, {
            q: value.isStudyToday === "0",
            s: common_vendor.o(($event) => goToDetail(value))
          });
        })
      } : {});
    };
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "D:/Study/JavaProject/uniapp_projects/smartDigital/pages/index/popular/otherPage/sign-in.vue"]]);

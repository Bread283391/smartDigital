<template>
	<view class="content" v-if="searchValue!==''">
		<view class="top-bar">
			<span class="top-text">搜索：{{ searchValue }}</span>
		</view>
...
searchValue.value=wx.getStorageSync("searchValue")
const classData=ref([
	{
		id:'1',
		classId:'12',
...
<style>
	.top-bar{
		...
		text-align: center;
		line-height: 100rpx;
		background:linear-gradient(to right,#ffffff,#409eff,#409eff,#409eff,#ffffff);
		color: #ffffff;
	}

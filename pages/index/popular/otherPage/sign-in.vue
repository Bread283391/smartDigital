		...
		<view v-for="(value,index) in classData"> 
			<view  class="card"  @click="goToDetail(value)">
				...
				<view class="button-box">
					<button class="button button1" @click="goToDetail(value,index)" v-if="value.isStudyToday==='1'">今日已打卡</button>
					<button class="button button2" @click="goToDetail(value,index)" v-else-if="value.isStudyToday==='0'">点击打卡</button>
				</view>
			</view>
		</view>
	</view>
